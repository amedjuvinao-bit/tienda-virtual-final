...
export function applyAdminGlobalStyles() {
  ...
  style.innerHTML = `
    ...
    /* Feature modules use their own class vocabularies. Match only
       structural containers so the selected material reaches every
       module without turning buttons, badges or icons into cards. */
    .admin-area :is(div, section, article, aside, form)[class$="-card"],
    .admin-area :is(div, section, article, aside, form)[class*="-card "],
    .admin-area :is(div, section, article, aside, form)[class$="__card"],
    .admin-area :is(div, section, article, aside, form)[class*="__card "],
    ...
    .admin-area :is(div, section, article, aside, form)[class*="__hero "],
    .admin-area :is(div, section, article, aside, form)[class$="-workspace"],
    .admin-area :is(div, section, article, aside, form)[class*="-workspace "],
    .admin-area :is(div, section, article, aside, form)[class$="__workspace"],
    .admin-area :is(div, section, article, aside, form)[class*="__workspace "],
    .admin-area :is(div, section, article, aside, form)[class$="-overview"],
    .admin-area :is(div, section, article, aside, form)[class*="-overview "],
    .admin-area :is(div, section, article, aside, form)[class$="__overview"],
    .admin-area :is(div, section, article, aside, form)[class*="__overview "],
    .admin-area :is(div, section, article, aside, form)[class$="-summary"],
    .admin-area :is(div, section, article, aside, form)[class*="-summary "],
    .admin-area :is(div, section, article, aside, form)[class$="__summary"],
    .admin-area :is(div, section, article, aside, form)[class*="__summary "],
    .admin-area :is(div, section, article, aside, form)[class$="-surface"],
    .admin-area :is(div, section, article, aside, form)[class*="-surface "],
    .admin-area :is(div, section, article, aside, form)[class$="__surface"],
    .admin-area :is(div, section, article, aside, form)[class*="__surface "],
    .admin-area :is(div, section, article, aside, form)[class$="-stats"],
    .admin-area :is(div, section, article, aside, form)[class*="-stats "],
    .admin-area :is(div, section, article, aside, form)[class$="__stats"],
    .admin-area :is(div, section, article, aside, form)[class*="__stats "],
    .admin-area :is(div, section, article, aside, form)[class$="-stat"],
    .admin-area :is(div, section, article, aside, form)[class*="-stat "],
    .admin-area :is(div, section, article, aside, form)[class$="-alerts"],
    .admin-area :is(div, section, article, aside, form)[class*="-alerts "],
    ...
    html[data-admin-widget-texture="liquidGlass"] .admin-area :is(
      ...
      :is(div, section, article, aside, form)[class*="__hero "],
      :is(div, section, article, aside, form)[class$="-workspace"],
      :is(div, section, article, aside, form)[class*="-workspace "],
      :is(div, section, article, aside, form)[class$="__workspace"],
      :is(div, section, article, aside, form)[class*="__workspace "],
      :is(div, section, article, aside, form)[class$="-overview"],
      :is(div, section, article, aside, form)[class*="-overview "],
      :is(div, section, article, aside, form)[class$="__overview"],
      :is(div, section, article, aside, form)[class*="__overview "],
      :is(div, section, article, aside, form)[class$="-summary"],
      :is(div, section, article, aside, form)[class*="-summary "],
      :is(div, section, article, aside, form)[class$="__summary"],
      :is(div, section, article, aside, form)[class*="__summary "],
      :is(div, section, article, aside, form)[class$="-surface"],
      :is(div, section, article, aside, form)[class*="-surface "],
      :is(div, section, article, aside, form)[class$="__surface"],
      :is(div, section, article, aside, form)[class*="__surface "],
      :is(div, section, article, aside, form)[class$="-stats"],
      :is(div, section, article, aside, form)[class*="-stats "],
      :is(div, section, article, aside, form)[class$="__stats"],
      :is(div, section, article, aside, form)[class*="__stats "],
      :is(div, section, article, aside, form)[class$="-stat"],
      :is(div, section, article, aside, form)[class*="-stat "],
      :is(div, section, article, aside, form)[class$="-alerts"],
      :is(div, section, article, aside, form)[class*="-alerts "],
