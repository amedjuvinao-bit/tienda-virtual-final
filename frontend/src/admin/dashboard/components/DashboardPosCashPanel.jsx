...
function GlassIcon({ children }) {
  return (
    <span
      ...
      style={{
        border:
          '1px solid color-mix(in srgb, var(--admin-primary) 24%, rgba(255,255,255,0.42))',
        background: `
          linear-gradient(
            145deg,
        ...
        boxShadow: `
          ...
          0 9px 18px rgba(12,6,35,0.060),
          0 0 14px color-mix(in srgb, var(--admin-primary) 13%, transparent)
        `,
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, rgba(255,255,255,0.06), rgba(255,255,255,0.22), rgba(255,255,255,0.06), transparent)',
          opacity: 0.42,
          filter: 'blur(0.4px)',
        }}
      />
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          {actionLabel && typeof onAction === 'function' ? (
            <button
              ...
              style={{
                border:
                  '1px solid color-mix(in srgb, var(--admin-primary) 22%, rgba(255,255,255,0.42))',
                background: `
                  linear-gradient(
                    145deg,
                ...
                boxShadow:
                  'inset 0 1px 0 rgba(255,255,255,0.46), 0 8px 16px rgba(12,6,35,0.055)',
              }}
            >
              {actionLabel}
            </button>
...
function ChannelRow({ item }) {
  ...
  return (
    <article
      ...
      style={{
        border:
          '1px solid color-mix(in srgb, var(--admin-primary) 16%, rgba(255,255,255,0.38))',
        background: `
          linear-gradient(
            145deg,
        ...
        `,
        boxShadow:
          'inset 0 1px 0 rgba(255,255,255,0.34), 0 8px 18px rgba(12,6,35,0.040)',
      }}
    >
        ...
        <div className="min-w-0 flex-1">
          ...
          <div
            ...
            style={{
              ...
              background: 'rgba(15,23,42,0.060)',
...
function CashMetric({ icon: Icon, label, value, helper }) {
  return (
    <div
      className="relative min-w-0 overflow-hidden rounded-[17px] p-3"
      style={{
        border:
          '1px solid color-mix(in srgb, var(--admin-primary) 14%, rgba(255,255,255,0.36))',
...
function OpenSessionCard({ session }) {
  ...
  return (
    <div
      ...
      style={{
        border:
          '1px solid color-mix(in srgb, var(--admin-primary) 18%, rgba(255,255,255,0.38))',
        background:
          'linear-gradient(145deg, rgba(255,255,255,0.060), rgba(255,255,255,0.015) 58%, color-mix(in srgb, var(--admin-primary) 5%, transparent))',
        ...
        <div
          ...
          style={{
            border:
              '1px solid color-mix(in srgb, var(--admin-primary) 22%, rgba(255,255,255,0.42))',
            background:
              'linear-gradient(145deg, color-mix(in srgb, var(--admin-primary) 8%, rgba(255,255,255,0.060)), rgba(255,255,255,0.015) 60%, color-mix(in srgb, var(--admin-primary) 5%, transparent))',
            boxShadow:
              'inset 0 1px 0 rgba(255,255,255,0.38), 0 10px 22px rgba(12,6,35,0.052)',
          }}
        >
