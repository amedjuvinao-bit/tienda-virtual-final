...
function GlassButton({ children }) {
  return (
    <button
      type="button"
      className="goal-pro-button relative inline-flex h-8 shrink-0 items-center justify-center gap-1 overflow-hidden rounded-[13px] px-2.5 text-[10.5px] font-black"
      style={{
        border:
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 mb-2.5 flex shrink-0 items-center justify-between gap-2">
          ...
          <GlassButton>Editar meta</GlassButton>
        </div>
