...
export const LOGIN_THEMES = {
  ...
  roseLuxuryLight: {
    ...
    customization: {
      ...
      welcomeSubtitle: "Ingresa al espacio privado de la tienda.",
  ...
  noirGallery: {
    id: "noirGallery",
    name: "Noir Gallery",
    description: "Galería nocturna, luz escultórica y lujo silencioso.",
    icon: Diamond,
    pageBg: "#09090b",
    deco1: "rgba(240,200,124,.18)",
    deco2: "rgba(104,74,255,.14)",
    cardBg: "rgba(16,16,19,.92)",
    cardBorder: "rgba(240,200,124,.28)",
    cardShadow: "0 40px 100px rgba(0,0,0,.58)",
    titleColor: "#f6f0e5",
    textColor: "#eee7dc",
    mutedColor: "#aaa298",
    ...
    inputText: "#ffffff",
    inputIconBg: "rgba(240,200,124,.1)",
    inputIconColor: "#f0c87c",
    buttonBg: "#f0c87c",
    buttonText: "#0a0a0c",
    buttonShadow: "0 18px 44px rgba(240,200,124,.18)",
    selectorBg: "#15161b",
    selectorBorder: "rgba(240,200,124,.22)",
    selectorActiveBg: "rgba(240,200,124,.1)",
    selectorActiveBorder: "#f0c87c",
    brandBadgeBg: "rgba(240,200,124,.1)",
    brandBadgeColor: "#f0c87c",
    glowColor: "#f0c87c",
    glowSoft: "rgba(240,200,124,.18)",
    glowStrong: "rgba(240,200,124,.35)",
    animatedBorder: "linear-gradient(120deg,#323036,#f0c87c,#323036)",
    customization: {
      primary: "#0a0a0c",
      secondary: "#1b1b21",
      accent: "#f0c87c",
      ...
      headline: "El negocio,",
      highlight: "en primer plano.",
      description: "Una sala privada para observar la operación completa y decidir con absoluta claridad.",
      welcomeTitle: "Sala privada",
      welcomeSubtitle: "Identifícate para abrir la galería de control.",
      buttonText: "Abrir la galería",
    },
  },
  ...
  auroraMotion: {
    id: "auroraMotion",
    name: "Aurora Motion",
    description: "Interfaz cinética, órbitas de luz y precisión tecnológica.",
    icon: Zap,
    pageBg: "#041724",
    deco1: "rgba(100,240,209,.22)",
    deco2: "rgba(185,108,255,.2)",
    cardBg: "rgba(6,27,43,.82)",
    cardBorder: "rgba(100,240,209,.3)",
    cardShadow: "0 36px 100px rgba(0,0,0,.45)",
    titleColor: "#effffd",
    textColor: "#e5fffb",
    mutedColor: "#a4c9c4",
    inputBg: "rgba(234,252,255,.07)",
    inputBorder: "rgba(100,240,209,.24)",
    inputText: "#ffffff",
    inputIconBg: "rgba(100,240,209,.1)",
    inputIconColor: "#64f0d1",
    buttonBg: "linear-gradient(120deg,#64f0d1,#8be4ff)",
    buttonText: "#041724",
    buttonShadow: "0 18px 46px rgba(100,240,209,.2)",
    selectorBg: "#0b3850",
    selectorBorder: "rgba(100,240,209,.24)",
    selectorActiveBg: "rgba(100,240,209,.1)",
    selectorActiveBorder: "#64f0d1",
    brandBadgeBg: "rgba(100,240,209,.1)",
    brandBadgeColor: "#64f0d1",
    glowColor: "#64f0d1",
    glowSoft: "rgba(100,240,209,.2)",
    glowStrong: "rgba(185,108,255,.32)",
    animatedBorder: "linear-gradient(120deg,#64f0d1,#b96cff,#8be4ff)",
    customization: {
      primary: "#041724",
      secondary: "#0b3850",
      accent: "#64f0d1",
      ...
      headline: "Decide hoy.",
      highlight: "Avanza primero.",
      description: "Toda la energía de la tienda converge en un espacio ágil, seguro y preparado para actuar.",
      welcomeTitle: "Sincroniza tu acceso",
      welcomeSubtitle: "Conecta con el centro operativo de la tienda.",
      buttonText: "Iniciar conexión",
    },
  },
  ...
  paperStudio: {
    id: "paperStudio",
    name: "Paper Studio",
    description: "Editorial audaz, geometría gráfica y movimiento creativo.",
    icon: SunMedium,
    pageBg: "#f7f0de",
    deco1: "rgba(18,38,170,.14)",
    deco2: "rgba(240,77,47,.16)",
    cardBg: "#fffdf5",
    cardBorder: "#1226aa",
    cardShadow: "18px 18px 0 rgba(18,38,170,.14)",
    titleColor: "#101b70",
    textColor: "#151515",
    mutedColor: "#5e5b52",
    inputBg: "transparent",
    ...
    inputText: "#151515",
    inputIconBg: "#f4dd52",
    inputIconColor: "#1226aa",
    buttonBg: "#1226aa",
    buttonText: "#ffffff",
    buttonShadow: "8px 8px 0 #f04d2f",
    selectorBg: "#fffdf5",
    selectorBorder: "#1226aa",
    selectorActiveBg: "#f4dd52",
    selectorActiveBorder: "#1226aa",
    brandBadgeBg: "#f4dd52",
    brandBadgeColor: "#1226aa",
    glowColor: "#1226aa",
    glowSoft: "rgba(18,38,170,.12)",
    glowStrong: "rgba(240,77,47,.2)",
    animatedBorder: "linear-gradient(120deg,#1226aa,#f04d2f,#f4dd52)",
    customization: {
      primary: "#1226aa",
      secondary: "#f04d2f",
      accent: "#f4dd52",
      surface: "#f7f0de",
      eyebrow: "ESTUDIO DE OPERACIONES",
      headline: "Ideas claras.",
      highlight: "Decisiones rápidas.",
      description: "Una entrada gráfica para administrar la tienda sin ruido, con ritmo y una visión completamente clara.",
      welcomeTitle: "Entra al estudio",
      welcomeSubtitle: "Tu mesa de trabajo está preparada.",
...
export function getLoginThemeCustomization(themeId) {
  const theme = LOGIN_THEMES[themeId] || LOGIN_THEMES[DEFAULT_LOGIN_THEME_ID];
  return { ...(theme.customization || LOGIN_THEMES[DEFAULT_LOGIN_THEME_ID].customization) };
}
