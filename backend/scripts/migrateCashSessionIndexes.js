...
const APPLY_FLAG = '--apply-cash-session-index-migration';
const PRODUCTION_CONFIRMATION_FLAG =
  '--confirm-production-cash-session-index-migration';

const migration = createCanonicalIndexMigration({
  applyFlag: APPLY_FLAG,
  productionFlag: PRODUCTION_CONFIRMATION_FLAG,
  codePrefix: 'CASH_SESSION_INDEX_MIGRATION',
  collection: 'cashsessions',
  definitions: CASH_SESSION_INDEX_DEFINITIONS,
});
