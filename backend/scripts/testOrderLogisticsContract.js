...
async function main() {
  ...
  assert(frontendSource.includes('Buscar opciones de envío'));
  assert(frontendSource.includes('Despacha este pedido en 3 pasos'));
  assert(frontendSource.includes('Haz esto ahora'));
  assert(frontendSource.includes('Crear la guía'));
  assert(frontendSource.includes('Preparar el paquete'));
  assert(frontendSource.includes('Esperar la entrega'));
  assert(frontendSource.includes('PASO ACTUAL'));
  assert(frontendSource.includes('Ver avance detallado del paquete'));
