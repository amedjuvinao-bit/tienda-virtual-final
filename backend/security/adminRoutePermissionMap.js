...
const ADMIN_ROUTE_PERMISSION_RULES = [
  ...
  {
    method: 'GET',
    path: '/api/admin/finance/cost-centers',
    permission: 'finance:view',
    description: 'Consultar centros de costo financieros.',
  },
  {
    method: 'POST',
    path: '/api/admin/finance/cost-centers',
    permission: 'finance:budgets:manage',
    description: 'Crear un centro de costo financiero.',
    audit: true,
  },
  {
    method: 'PUT',
    path: '/api/admin/finance/cost-centers/:id',
    permission: 'finance:budgets:manage',
    description: 'Actualizar un centro de costo financiero.',
    audit: true,
  },
  {
    method: 'GET',
    path: '/api/admin/finance/budgets',
    permission: 'finance:view',
    description: 'Consultar presupuestos dentro de las sedes autorizadas.',
  },
  {
    method: 'POST',
    path: '/api/admin/finance/budgets',
    permission: 'finance:budgets:manage',
    description: 'Crear un presupuesto mensual por sede y centro de costo.',
    audit: true,
  },
  {
    method: 'PUT',
    path: '/api/admin/finance/budgets/:id',
    permission: 'finance:budgets:manage',
    description: 'Ajustar un presupuesto mensual con control de versión.',
    audit: true,
  },
  {
    method: 'GET',
    path: '/api/admin/finance/budget-control',
    permission: 'finance:view',
    description: 'Consultar comprometido, ejecutado y disponible del presupuesto.',
  },
  {
    method: 'GET',
