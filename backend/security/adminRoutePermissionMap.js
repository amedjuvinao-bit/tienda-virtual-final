...
const ADMIN_ROUTE_PERMISSION_RULES = [
  ...
  },
  {
    ...
    path: '/api/admin/branches/:id',
    permission: 'branches:update',
    description: 'Editar parcialmente sede.',
    audit: true,
  },
  {
    method: 'PATCH',
    path: '/api/admin/branches/:id/fiscal',
    permission: 'branches:fiscal',
    description: 'Editar datos fiscales de sede.',
    audit: true,
  },
  {
    method: 'DELETE',
    ...
    description: 'Desactivar o eliminar sede.',
    audit: true,
    danger: true,
  },
